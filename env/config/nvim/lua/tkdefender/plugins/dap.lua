return {
  {
    ...
    config = function()
      ...
      map.set("n", "<leader>dc", function() dap.continue() end)
      map.set("n", "<leader>ds", function() dap.step_over() end)
      map.set("n", "<leader>dsi", function() dap.step_into() end)
      map.set("n", "<leader>dso", function() dap.step_out() end)
      ...
      map.set("n", "<leader>dgt", function() dap_go.debug_test() end)
    end
  },
  {
